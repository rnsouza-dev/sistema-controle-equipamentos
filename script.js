...
function baixarPlanilhaModelo() {
    try {
        // 1. Definir o cabeçalho esperado
        const cabecalho = [["Nome", "Usuário", "Setor", "Turno"]];
        ...
        // 4. Forçar o download usando write e um Blob (Mais seguro para navegadores)
        ...
        a.href = url;
        a.download = "modelo_colaboradores_hosplog.xlsx";
        ...
        alert("Erro ao baixar planilha: Verifique se a biblioteca Excel carregou corretamente.");
    }
}